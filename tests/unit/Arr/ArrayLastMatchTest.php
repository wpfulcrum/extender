...
class ArrayLastMatchTest extends TestCase
{
    ...
    public function testCallback()
    {
        ...
        $this->assertEquals(
            ...
            array_get_last_match(
                $this->dataSet,
                'Fulcrum\Tests\Unit\Extender\Arr\isEvenCallback'
            )
        );
        $expected = 6;
        $this->assertEquals(
            ...
            array_get_last_match(
                $this->dataSet,
                'Fulcrum\Tests\Unit\Extender\Arr\isDivisibleBy3Callback'
            )
        );
        $expected = [
            'user_id'    => 601,
        ...
        $this->assertEquals(
            ...
            array_get_last_match(
                $this->users,
                'Fulcrum\Tests\Unit\Extender\Arr\doesNotHaveAccess'
            )
        );
    }
    ...
    public function testStaticCallback()
    {
        ...
        $this->assertEquals(
            ...
            array_get_last_match(
                $this->dataSet,
                ['Fulcrum\Tests\Unit\Extender\Arr\CallbackStub', 'isEvenStatic']
            )
        );
        ...
        $this->assertEquals(
            ...
            array_get_last_match(
                $this->users,
                'Fulcrum\Tests\Unit\Extender\Arr\CallbackStub::hasAccessStatic'
            )
        );
    }
}
