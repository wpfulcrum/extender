...
namespace Fulcrum\Extender\Tests\Unit;

if (version_compare(phpversion(), '5.6.0', '<')) {
    die('Whoops, PHP 5.6 or higher is required.');
}

define('FULCRUM_EXTENDER_TESTS_DIR', __DIR__);
define('FULCRUM_EXTENDER_ROOT_DIR', dirname(dirname(FULCRUM_EXTENDER_TESTS_DIR)) . DIRECTORY_SEPARATOR);
